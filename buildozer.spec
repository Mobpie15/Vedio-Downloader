...
# Useful when bblimke fails to detect symlinks (e.g. on Windows)
#android.copy_libs = 1
...
# Control passing the --private flag to compile.py
# p4a.private = 

# (str) Extra command line arguments to pass when calling pythonforandroid.toolchain
#p4a.extra_args =

# (str) Extra command line arguments to pass when calling apksigner
#apksigner.extra_args =

# (str) Extra command line arguments to pass when calling aapt
#aapt.extra_args =

# (str) Extra command line arguments to pass when calling zipalign
#zipalign.extra_args =

# (bool) Whether or not to open the file browser during the build
#p4a.open_file_browser = False

# (str) The command used to run the application in debug mode
#p4a.debug_cmd = gdb

# (str) The command used to run the application in release mode
#p4a.release_cmd = gdb
...
# (list) Android application meta-data to set (key=value format)
# Refer to https://developer.android.com/guide/topics/manifest/meta-data-element
# android.meta_data =
...
# (str) URL pointing to a zip file containing the .app file
#ios.manifest.app_zip_url =

# (str) URL pointing to an icon file
